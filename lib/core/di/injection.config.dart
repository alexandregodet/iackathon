...
import '../../data/datasources/stt_service.dart' as _i955;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.singleton<_i307.ChecklistService>(() => _i307.ChecklistService());
    ...
    gh.singleton<_i955.SttService>(() => _i955.SttService());
