...
import '../../data/datasources/ask_pdf_service.dart' as _i822;
...
import '../../data/datasources/pdf_image_service.dart' as _i378;
...
import '../../presentation/blocs/ask_pdf/ask_pdf_bloc.dart' as _i1063;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.singleton<_i822.AskPdfService>(() => _i822.AskPdfService());
    gh.singleton<_i104.AppDatabase>(() => _i104.AppDatabase());
    gh.singleton<_i363.GemmaService>(() => _i363.GemmaService());
    gh.singleton<_i378.PdfImageService>(() => _i378.PdfImageService());
    ...
    gh.factory<_i1063.AskPdfBloc>(
      () => _i1063.AskPdfBloc(
        gh<_i363.GemmaService>(),
        gh<_i822.AskPdfService>(),
      ),
    );
