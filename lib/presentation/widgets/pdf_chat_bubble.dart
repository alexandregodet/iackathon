...
/// Chat bubble for PDF Q&A with source citations
class PdfChatBubble extends StatefulWidget {
  final PdfChatMessage message;
  final bool isCurrentlyThinking;
  final int? highlightedSourceIndex;
  final ValueChanged<int>? onSourceTapped;
  ...
  @override
  State<PdfChatBubble> createState() => _PdfChatBubbleState();
}

class _PdfChatBubbleState extends State<PdfChatBubble> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (!isUser &&
              widget.message.hasSources &&
              !widget.message.isStreaming) ...[
            const SizedBox(height: 10),
            _buildSourcesSummary(context, colorScheme, isDark),
          ],
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      thinkingInProgress ? '# reflexion...' : '# raisonnement',
                      style: TextStyle(
                        fontSize: 11,
        ...
        children: [
          ...
          Wrap(
            ...
            children: sources.map((source) {
              final isHighlighted =
                  widget.highlightedSourceIndex == source.sourceIndex;

              return Material(
                color: Colors.transparent,
                child: InkWell(
                  onTap: () => widget.onSourceTapped?.call(source.sourceIndex),
                  borderRadius: BorderRadius.circular(4),
                  child: Container(
